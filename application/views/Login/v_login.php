				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
							<form action="LoginController/validar_login" id="login-form" class="smart-form client-form" method="POST">
								<header>
									Login
								</header>
								<fieldset>
									...
									<section>
										...
										<div class="note">
											<a href="forgotpassword.html">Olvidaste el password?</a>
										</div>
									</section>
