		...
		<div id="main" role="main">
			...
			<form class="lockscreen animated flipInY" action="LoginController/validar_login" method="POST" id="lock-form">
				...
				<div>
					...
					<div>
						<h1><i class="fa fa-user fa-3x text-muted air air-top-right hidden-mobile"></i> <?= $rememberData['nombre']; ?> <small><i class="fa fa-lock text-muted"></i> &nbsp;bloqueado</small></h1>
						<p class="text-muted">
						...
						<div class="input-group">
							...
							<input class="form-control" type="password" name="password" id="password" placeholder="Contraseña" type="submit">
							<br>
						...
						<p class="no-margin margin-top-5">
							Entrar como alguien mas? <a href="LoginController"> Click aca</a>
						</p>
					</div>
